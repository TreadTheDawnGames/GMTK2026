...
@export_range(0, 1_000_000, 8) var minimum_depth_px: int = 0
@export_range(0, 1_000_000, 8) var maximum_depth_px: int = 100_000


## Reports whether this ore is allowed at the supplied descent.
func can_spawn_at_depth(depth_px: int) -> bool:
	return (
		depth_px >= minimum_depth_px
		and depth_px <= maximum_depth_px
	)
